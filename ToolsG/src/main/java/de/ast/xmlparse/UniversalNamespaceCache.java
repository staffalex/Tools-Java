...
public class UniversalNamespaceCache implements NamespaceContext {
   ...
   */
  public UniversalNamespaceCache(Document document, boolean recursiveNamespaceCache) {
    examineNode(document.getFirstChild(), recursiveNamespaceCache);
   ...
   */
  private void examineNode(Node node, boolean recursiveNamespaceCache) {
